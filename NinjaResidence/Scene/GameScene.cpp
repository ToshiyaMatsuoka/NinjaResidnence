...
void GameScene::KeyOperation() {
	...
	if (KeyOn == m_pDirectX->GetKeyStatus(DIK_V) || PadOn == m_pXinputDevice->GetTriggerLState())
	{
...
void GameScene::StageTurning()
{
	switch (m_StageNum) {
	case 0:
		StageFilePath_surface = "Resource/csv/TUTORIAL_A.csv";
		StageFilePath_reverse = "Resource/csv/TUTORIAL_B.csv";
		m_BGMSoundKey = "TUTORIAL";
		break;
	case 1:
		StageFilePath_surface = "Resource/csv/STAGE1_A.csv";
		StageFilePath_reverse = "Resource/csv/STAGE1_B.csv";
		m_BGMSoundKey = "STAGE_1";
		break;
	case 2:
		StageFilePath_surface = "Resource/csv/STAGE2_A.csv";
		StageFilePath_reverse = "Resource/csv/STAGE2_B.csv";
		m_BGMSoundKey = "STAGE_2";
		break;
	case 3:
		StageFilePath_surface = "Resource/csv/STAGE3_A.csv";
		StageFilePath_reverse = "Resource/csv/STAGE3_B.csv";
		m_BGMSoundKey = "STAGE_3";
		break;
	case 4:
		StageFilePath_surface = "Resource/csv/STAGE4_A.csv";
		StageFilePath_reverse = "Resource/csv/STAGE4_B.csv";
		m_BGMSoundKey = "STAGE_4";
		break;
	case 5:
		StageFilePath_surface = "Resource/csv/STAGE5_A.csv";
		StageFilePath_reverse = "Resource/csv/STAGE5_B.csv";
